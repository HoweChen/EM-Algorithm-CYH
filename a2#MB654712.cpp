...
void Pretend_Label_Correct(
  int count_n2, int count_n1, int count_0, int count_1, int count_2,
  std::array<std::array<double, MAX_LEVEL>, MAX_DATA>& majority_table, int row);

void Clear_Count(int& count_n2, int& count_n1, int& count_0, int& count_1,
                 int& count_2);
...
void Check_If_Cover(
  std::vector<int>& last_iteration, std::vector<int>& new_iteration,
  std::array<std::array<double, MAX_LEVEL>, MAX_DATA> majority_table);
...
void
Clear_Count(int& count_n2, int& count_n1, int& count_0, int& count_1,
            int& count_2)
{
  count_n2 = 0;
  count_n1 = 0;
